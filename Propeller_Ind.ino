...
int const NUM_PIXELS = 101;

// указываем количество пикселей в матрице и пин подключения
Adafruit_NeoPixel strip1 (NUM_PIXELS, 7, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel strip2 (NUM_PIXELS, 6, NEO_GRB + NEO_KHZ800);
//Adafruit_NeoPixel strip2 (NUM_PIXELS, 7, NEO_GRB + NEO_KHZ800);
